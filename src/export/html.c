...
"#graph { display: block; width: 100%%; max-width: 100%%; height: 800px; border: 1px solid #333; border-radius: 8px; background: #0f3460; overflow: hidden; }\n"
...
"  const width = svg.node().getBoundingClientRect().width || document.body.clientWidth - 40 || 1200;\n"
"  const height = 800;\n"
